...
from utils.reidtools import (visualize_ranked_results, eval_market1501)
from utils.torchtools import (
    save_checkpoint, open_all_layers, open_specified_layers
)
from utils.avgmeter import (MetricMeter, AverageMeter)
from utils.distance import compute_distance_matrix

class Engine(object):
    r"""A generic base Engine class for reid.
